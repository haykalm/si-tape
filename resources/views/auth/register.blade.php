...
<div class="register-box">
  <div class="register-logo">
    <a href="{{ asset('AdminLTE-2') }}/index2.html"><b>Admin</b>LTE</a>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg">Register to user disdukcapil Bekasi</p>
    ...
    <form action="{{ route('register') }}" method="POST">
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat ml-2">Register</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
