                ...
                <div class="col-xs-12">
                    <div class="box box-default">
                        <div class="box-header with-border">
                            <h3 class="box-title">List Kegiatan Per-yayasan</h3>
                        </div>
                        <div class="box-body">
                            <a href="{{url('/event/create')}}" type="button" class="btn btn-default" title="Add">
                        ...
                        <tr style="text-align:center;font-size: 13px;">
                            ...
                            <td style="display: flex;justify-content:center;">
                               <a class="btn btn-success btn-xs show_confirm" onClick="show({{ $value->id_event }})" data-nama="#" data-toggle="tooltip" title="show images" style="margin-right: 2px">
                                ...
                                <a href="{{url('/event_pdf', base64_encode($value->id_event),)}}" class="btn btn-primary btn-xs show_confirm" title="Download Event" style="margin-right: 2px" target="_blank">
