                ...
                <div class="col-xs-12">
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            ...
                            <a href="{{url('/disabilitas_pdf')}}" class="btn btn-info" title="Download/Pdf" target="_blank">
                                <i class="fa fa-fw fa-print"></i>
                                Print
                            </a>
                            <a href="{{url('/disablitas_excel')}}" title="Download/Excel" class="btn btn-success my-3"><i class="fa fa-fw fa-file-excel-o"></i>
                               Excel
                            </a>
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
                    @if(!empty($disabilitas))
                        ...
                        @foreach($disabilitas as $data => $value)
            ...
            <form method="POST" action="{{url('/penduduk')}}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group has-feedback">
                        <input type="hidden" name="kategori_pr_id" value="3" class="form-control">
                    </div>
                    <div class="form-group has-feedback">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit disabilitas</h5>
            </div>
            <div class="modal-body">
